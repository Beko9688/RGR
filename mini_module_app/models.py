...
class Files(models.Model):
    subjects = (('Устройство и эволюция программного обеспечения', 'Устройство и эволюция программного обеспечения',),
                ('Управление ИТ-проектами', 'Управление ИТ-проектами',),
                ('Предварительная отработка данных', 'Предварительная отработка данных',),
